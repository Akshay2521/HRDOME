...
import com.app.hrdrec.organization.leavetypes.locations_response.LocationListResponse

class LocationSpinnerAdapter(var data: ArrayList<LocationListResponse>) : BaseAdapter(),
...
//                binding.imgCheck.visibility = View.GONE
        binding.relation = data[position].locationName
//            }else{
...
//            }
    ...
    fun updateList(list: ArrayList<LocationListResponse>) {
        this.data = list
