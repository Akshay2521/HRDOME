...
class RolesSpinnerAdapter(var data: ArrayList<GetAllRolesResponseData>) : BaseAdapter(),
...
//                binding.imgCheck.visibility = View.GONE
        binding.relation = data[position].roleName
//            }else{
...
//            }
    ...
    fun updateList(list: ArrayList<GetAllRolesResponseData>) {
        this.data = list
    }
