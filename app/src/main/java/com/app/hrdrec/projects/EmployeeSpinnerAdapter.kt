...
class EmployeeSpinnerAdapter(var data: ArrayList<EmployeeListResponse>) : BaseAdapter(),
...
//                binding.imgCheck.visibility = View.GONE
        binding.relation = data[position].employeeName
//            }else{
...
//            }
    ...
    fun updateList(list: ArrayList<EmployeeListResponse>) {
        this.data = list
