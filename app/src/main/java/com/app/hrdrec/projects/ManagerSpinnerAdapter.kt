...
class ManagerSpinnerAdapter(var data: ArrayList<ManagerListResponse>) : BaseAdapter(),
...
//                binding.imgCheck.visibility = View.GONE
        binding.relation = data[position].managerName
//            }else{
...
//            }
    ...
    fun updateList(list: ArrayList<ManagerListResponse>) {
        this.data = list
